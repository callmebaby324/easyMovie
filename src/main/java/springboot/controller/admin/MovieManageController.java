...
//public class MovieManageController extends AbstractController {
//    private static final Logger logger = LoggerFactory.getLogger(MovieManageController.class);
//
//    @Resource
...
//        PageInfo<Movie> movies = movieService.getMovies(page, limit);
